...
parser.add_argument('--i0', type=float, help='Initial fraction of infected nodes', default=0.0000527)
...
prob = 14.7/N # Probability of connection between two individuals
