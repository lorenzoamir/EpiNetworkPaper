...
def create_network(N, k_min, k_max, gamma):
...
def simulate(N, k_min, k_max, gamma, i0, t_max, beta_default, mu, alpha=0, seed=42, N_steps=10):

    G = create_network(N, k_min, k_max, gamma)
